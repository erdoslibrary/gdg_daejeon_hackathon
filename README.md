...
>**후기**: 각오하고 갔지만, 주제를 가지고 아이디어 생각, 구현, 발표 준비까지 4시간 안에 하는 건 진짜 힘들었습니다. 그래도 머리 박아가면서 하다보면 뭔가 나오기는 하니까 무척 즐거웠습니다.
> - 미처 구현하지 못한 사진 인증 부분과 한계점 및 mock데이터로 구현한 점은 개인적으로 아쉽습니다. 그리고 ppt 만드는 툴도 좀 배워야 겠음.. 🥲
>- 그래도 하다보면 되네요? 현재 ai 툴들은 너무 똑똑하고 잘만 쓰면 뚝딱 뚝딱 만듭니다. 디테일이 아쉬워서 그렇지 80%는 괜찮.
> - 다음에는 Vertex AI · AI Studio도 잘 써보겠습니다. (그런데 이거 공부할 시간에 리눅스를 공부하고 싶...)